...
public class WX_UserUtil {
     private static Logger log = LoggerFactory.getLogger(WX_UserUtil.class);
        ...
        public static Integer subscribeState(String openId){
            String tmpurl = "https://api.weixin.qq.com/cgi-bin/user/info?access_token="+WeixinUtil.getAccessToken("wx44eb1076428bc798","b08848aaefe1e17715656b867fe0da48") +"&openid="+openId;
