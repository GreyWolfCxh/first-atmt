...
public class WX_TemplateMsgUtil {
    ...
    public static String getWXTemplateMsgId(String templateSerialNumber){
        String tmpurl = "https://api.weixin.qq.com/cgi-bin/template/api_add_template?access_token="+ WeixinUtil.getAccessToken("wx44eb1076428bc798","b08848aaefe1e17715656b867fe0da48").getToken();
        JSONObject json = new JSONObject();
    ...
    public static String deleteWXTemplateMsgById(String templateId){
        String tmpurl = "https://api.weixin.qq.com/cgi-bin/template/del_private_template?access_token="+WeixinUtil.getAccessToken("wx44eb1076428bc798","b08848aaefe1e17715656b867fe0da48").getToken();
        JSONObject json = new JSONObject();
    ...
    public static String sendWechatMsgToUser(String touser, String templatId, String clickurl, String topcolor, JSONObject data) {
        String tmpurl = "https://api.weixin.qq.com/cgi-bin/message/template/send?access_token="+WeixinUtil.getAccessToken("wx44eb1076428bc798","b08848aaefe1e17715656b867fe0da48").getToken();
        JSONObject json = new JSONObject();
